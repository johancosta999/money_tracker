    ...
    <div className="dashboard-page">
        ...
        <div className="dashboard-priority-actions">
          <Link to="/transactions/add" className="add-transaction-button">
            ...
            <div>
              ...
              <p>Record your income or spending</p>
            </div>
          </Link>
          ...
          <Link to="/planner" className="add-transaction-button planner-button">
            ...
            <div>
              <strong>View Your Planners</strong>

              <p>Plan and manage your budget</p>
            </div>
          </Link>
        </div>
      </section>
      ...
      <section className="summary-grid">
        <div className="summary-card">
          ...
          <div>
            ...
            <h3>Rs. {summary.totalIncome.toLocaleString()}</h3>
          </div>
        </div>
        ...
        <div className="summary-card">
          ...
          <div>
            ...
            <h3>Rs. {summary.totalExpense.toLocaleString()}</h3>
          </div>
        </div>
      ...
      <section className="dashboard-section">
        ...
        <div className="quick-actions">
          <Link to="/transactions/all" className="quick-action-card">
            <div className="quick-action-icon">💳</div>

            <div>
              <h3>All transactions</h3>

              <p>View all of your incomes and expenses.</p>
            </div>
          </Link>

          <Link to="/bank-transactions" className="quick-action-card">
            <div className="quick-action-icon">🏦</div>

            <div>
              <h3>Bank transactions</h3>

              <p>View all of your deposits and withdraws from your bank.</p>
            </div>
          </Link>
        </div>
      </section>
